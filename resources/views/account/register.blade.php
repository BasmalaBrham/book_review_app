                            ...
                            <div class="card-body p-3 p-md-4 p-xl-5">
                                ...
                                <form action="{{route('account.processRegister')}}" method="POST">
                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type="password" class="form-control" value="{{old('password')}}" name="password" id="password" value="" placeholder="Password" >
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type="password" class="form-control" value="{{old('password_confirmation')}}" name="password_confirmation" id="confirm_password" value="" placeholder="Confirm Password" >
