                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('books.update',$book->id)}}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Author"  name="author" id="author" value="{{old('author',$book->author)}}"/>
                            ...
                            <div class="mb-3">
                                ...
                                @endif
                                @if (!empty($book->image))
                                    <div style="width: 200px; height: 200px; overflow: hidden; margin-top: 1rem;">
                                        <img style="width: 100%; height: auto;" src="{{ asset('upload/books/' . $book->image) }}" alt="{{ $book->title }}">
                                    </div>
                                @endif
                            </div>
                            <div class="mb-3">
